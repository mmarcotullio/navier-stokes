...
class FNO3d(nn.Module):
    ...
    def __init__(
        ...
        """
        Args:
            modes_x, modes_y, modes_z: number of retained Fourier modes.
            width:   channel width for latent representation.
            in_channels: input feature channels
                         (x_norm, y_norm, z_norm, fluid_mask, cyl_mask, Re_norm, U_in_norm).
            out_channels: output channels (u_x, u_y, u_z, p) — equilibrium field.
        """
        super().__init__()
